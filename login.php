  ...
  <div class="form">
   <div class="alert alert-danger alert-dismissible fade <?php if($show){echo"show";}else{echo"hide";}?>">
    ...
    <form class="login-form" method="post" action="login.php">
      <i style="font-size: 40px;color: #F96747;text-align: center;width: 100%;" class="fa fa-sliders" aria-hidden="true"></i>
      <p style="font-weight: 600;font-size: 20px;color: #F96747;text-align: center;">Monuments Catalog Login</p>
      <p style="color: #F96747;font-weight: 600;">E-mail</p>
      <input type="text" placeholder="example@gmail.com" name="email">
      <p style="color: #F96747;font-weight: 600;">Password</p>
